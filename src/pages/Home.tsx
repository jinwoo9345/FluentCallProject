                ...
                <section>
                  ...
                  <div className="bg-blue-50/50 p-8 rounded-[2rem] border border-blue-100/50">
                    <p className="text-slate-800 text-lg leading-relaxed font-medium">
                      ...
                      <span className="text-blue-700 font-black underline decoration-blue-200">추천인에게 다음 달 사용 가능한 20,000 포인트</span>가 지급됩니다.
                    </p>
                    <ul className="mt-6 space-y-3 text-slate-600">
                      <li className="flex items-center gap-2">• 지급된 포인트는 다음 달 결제 시 <strong>자동 적용</strong>됩니다.</li>
                      <li className="flex items-center gap-2">• 포인트 적용 시 다음 달 결제 금액은 <strong>159,000원</strong>으로 할인됩니다.</li>
                    </ul>
                  </div>
                </section>
                <section>
                  ...
                  <ul className="space-y-4 text-slate-600">
                    <li className="flex gap-4">
                      ...
                      <p>포인트는 <strong>수강을 유지하는 경우에만</strong> 사용 가능합니다.</p>
                    </li>
                    <li className="flex gap-4">
                      <div className="h-2 w-2 rounded-full bg-slate-300 mt-2 flex-shrink-0" />
                      <p>추천받은 친구는 별도의 할인 없이 <strong>정상가(179,000원)</strong>로 결제됩니다.</p>
                    </li>
                    <li className="flex gap-4">
                      <div className="h-2 w-2 rounded-full bg-slate-300 mt-2 flex-shrink-0" />
                      <p>단, 추천인과 친구 간 협의하여 <strong>포인트를 나누어 사용하는 것은 가능</strong>합니다.</p>
                    </li>
                  </ul>
                </section>
                <div className="pt-6">
